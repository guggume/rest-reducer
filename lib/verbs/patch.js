...
export const patch = applyMiddleware((state, { patchId, value } = {}) => {
  ...
  return {
    ...
    [PATCHES]: {
      ...
      [patchId]: {
        ...item,
        ...changeMeta(STATES.PENDING, VERBS.PATCH),
      },
    },
  };
}, [checkStateMW]);

export const patchSuccess = applyMiddleware((state, { id, patchId, code } = {}) => {
  ...
  return {
    ...
    [ITEMS]: {
      ...
      [id]: {
        ...state[ITEMS][id],
        ...changeMeta(STATES.SYNCED, VERBS.PATCH)
      },
    },
  };
}, [checkStateMW]);

export const patchFailure = applyMiddleware((state, { id, patchId, code } = {}) => {
  ...
  return {
    ...
    [PATCHES]: {
      ...
      [patchId]: {
        ...item,
        ...changeMeta(STATES.FAILED, VERBS.PATCH),
      },
    },
  };
