...
export default function(globalParams = {}, config = {}) {
  ...
  const getAll = (url, { PENDING, SUCCESS, FAILURE }, params = {}) => (
    query,
    meta,
  ...
  const put = (url, { PENDING, SUCCESS, FAILURE }, params = {}, raw = false) => (
    id,
    value,
    meta,
  ) => async (dispatch, getState) => {
  ...
  const post = (url, { PENDING, SUCCESS, FAILURE }, params = {}, raw = false) => (
    id,
    value,
    meta,
  ) => async (dispatch, getState) => {
  ...
  const patch = (url, { PENDING, SUCCESS, FAILURE }, params = {}, raw = false) => (
    patchId,
    id,
    value,
    meta,
  ...
  const remove = (url, { PENDING, SUCCESS, FAILURE }, params = {}) => (
    id,
    meta,
  ) => async (dispatch, getState) => {
    dispatch({
  ...
  const removeAll = (url, { PENDING, SUCCESS, FAILURE }, params = {}, raw = false) => (
    id,
    ids,
    value,
    meta,
